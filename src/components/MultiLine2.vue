    ...
    export default {
        methods:
        {
            chart(evt)
            {
		        ...
		        var svg_reset = d3.select("#multiLineChart2")
		        ...
		        // Append SVG to page
		        var svg = d3.select("#multiLineChart2")
		      	  .append("svg")
      ...
      // Add legend text
        ...
        .style("font-weight", 600)
			  ...
			  .on("click", function(){
			  	  var new_opacity = 0.5;
				  var a = d3.select('#boredapeline2')
				  d3.select('#boredapeline2')
				      .transition().duration(0)
				      .style("opacity", new_opacity)
				  a.classed("active", false)
				  a = d3.select('#boredapekennelline2')
				  d3.select('#boredapekennelline2')
				        .transition().duration(0)
					.style("opacity", new_opacity)
				  a.classed("active", false)
				  a = d3.select('#clonexline2')
				  d3.select('#clonexline2')
					.transition().duration(0)
					.style("opacity", new_opacity)
				  a.classed("active", false)
				  a = d3.select('#coolcatline2')
				  d3.select('#coolcatline2')
					.transition().duration(0)
					.style("opacity", new_opacity)
				  a.classed("active", false)
				  a = d3.select('#cryptoadline2')
				  d3.select('#cryptoadline2')
					.transition().duration(0)
					.style("opacity", new_opacity)
				  a.classed("active", false)
				  a = d3.select('#doodleline2')
				  d3.select('#doodleline2')
					.transition().duration(0)
					.style("opacity", new_opacity)
				  a.classed("active", false)
				  a = d3.select('#penguinline2')
				  d3.select('#penguinline2')
					.transition().duration(0)
					.style("opacity", new_opacity)
				  a.classed("active", false)
				  a = d3.select('#punkline2')
				  d3.select('#punkline2')
					.transition().duration(0)
					.style("opacity", new_opacity)
				  a.classed("active", false)
